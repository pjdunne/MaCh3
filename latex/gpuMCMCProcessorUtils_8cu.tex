\hypertarget{gpuMCMCProcessorUtils_8cu}{}\doxysection{/home/runner/work/\+Ma\+Ch3/\+Ma\+Ch3/mcmc/gpu\+MCMCProcessor\+Utils.cu File Reference}
\label{gpuMCMCProcessorUtils_8cu}\index{/home/runner/work/MaCh3/MaCh3/mcmc/gpuMCMCProcessorUtils.cu@{/home/runner/work/MaCh3/MaCh3/mcmc/gpuMCMCProcessorUtils.cu}}
{\ttfamily \#include \char`\"{}mcmc/gpu\+MCMCProcessor\+Utils.\+cuh\char`\"{}}\newline
Include dependency graph for gpu\+MCMCProcessor\+Utils.\+cu\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=309pt]{gpuMCMCProcessorUtils_8cu__incl}
\end{center}
\end{figure}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\+\_\+\+\_\+host\+\_\+\+\_\+ void \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_a5f83eaf9a69d10b00a4078608bdd0674}{Init\+GPU\+\_\+\+Auto\+Corr}} (float $\ast$$\ast$Par\+Step\+\_\+gpu, float $\ast$$\ast$Numerator\+Sum\+\_\+gpu, float $\ast$$\ast$Param\+Sums\+\_\+gpu, float $\ast$$\ast$Denom\+Sum\+\_\+gpu, int n\+\_\+\+Entries, int n\+\_\+\+Pars, const int n\+\_\+\+Lags)
...
\+\_\+\+\_\+host\+\_\+\+\_\+ void \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_a6388d047bba2ea16de2bcb73ca0e398c}{Copy\+To\+GPU\+\_\+\+Auto\+Corr}} (float $\ast$Par\+Step\+\_\+cpu, float $\ast$Numerator\+Sum\+\_\+cpu, float $\ast$Param\+Sums\+\_\+cpu, float $\ast$Denom\+Sum\+\_\+cpu, float $\ast$Par\+Step\+\_\+gpu, float $\ast$Numerator\+Sum\+\_\+gpu, float $\ast$Param\+Sums\+\_\+gpu, float $\ast$Denom\+Sum\+\_\+gpu)
\begin{DoxyCompactList}\small\item\em KS\+: Copy necessary variables from CPU to GPU. \end{DoxyCompactList}\item 
\+\_\+\+\_\+global\+\_\+\+\_\+ void \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_a2e9d69f5be6976ac042f93045753acf9}{Eval\+On\+GPU\+\_\+\+Auto\+Corr}} (const float $\ast$\+\_\+\+\_\+restrict\+\_\+\+\_\+ Par\+Step\+\_\+gpu, const float $\ast$\+\_\+\+\_\+restrict\+\_\+\+\_\+ Param\+Sums\+\_\+gpu, float $\ast$Numerator\+Sum\+\_\+gpu, float $\ast$Denom\+Sum\+\_\+gpu)
\begin{DoxyCompactList}\small\item\em Eval autocorrelations based on Box and Jenkins. \end{DoxyCompactList}\item 
\+\_\+\+\_\+host\+\_\+\+\_\+ void \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_a809672193d24a096e6d4865109357070}{Run\+GPU\+\_\+\+Auto\+Corr}} (float $\ast$Par\+Step\+\_\+gpu, float $\ast$Param\+Sums\+\_\+gpu, float $\ast$Numerator\+Sum\+\_\+gpu, float $\ast$Denom\+Sum\+\_\+gpu, float $\ast$Numerator\+Sum\+\_\+cpu, float $\ast$Denom\+Sum\+\_\+cpu)
...
\+\_\+\+\_\+host\+\_\+\+\_\+ void \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_abb46837d774b5be81a6c601c762ab05a}{Cleanup\+GPU\+\_\+\+Auto\+Corr}} (float $\ast$Par\+Step\+\_\+gpu, float $\ast$Numerator\+Sum\+\_\+gpu, float $\ast$Param\+Sums\+\_\+gpu, float $\ast$Denom\+Sum\+\_\+gpu)
\begin{DoxyCompactList}\small\item\em KS\+: free memory on gpu. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\+\_\+\+\_\+device\+\_\+\+\_\+ \+\_\+\+\_\+constant\+\_\+\+\_\+ int \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_af8f4968d58719d599f3d6ac1adecf9bd}{d\+\_\+n\+Lag}}
\item 
\+\_\+\+\_\+device\+\_\+\+\_\+ \+\_\+\+\_\+constant\+\_\+\+\_\+ int \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_ad9b41c473ce2b52f562c1809d6b233ca}{d\+\_\+n\+Draws}}
\item 
\+\_\+\+\_\+device\+\_\+\+\_\+ \+\_\+\+\_\+constant\+\_\+\+\_\+ int \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_a2612fc014389124064ca4e2c9c2eb616}{d\+\_\+n\+Entries}}
\item 
static int \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_a3d609e7d3946c09c05beebd1f703f355}{h\+\_\+n\+Lag}} = -\/1
\item 
static int \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_afe4d63f9540a121d02444724ba2abe10}{h\+\_\+n\+Draws}} = -\/1
\item 
static int \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_adbc5ade24b4b04c29d1437f78a3f8923}{h\+\_\+n\+Entries}} = -\/1
\end{DoxyCompactItemize}


\doxysubsection{Function Documentation}
\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_abb46837d774b5be81a6c601c762ab05a}\label{gpuMCMCProcessorUtils_8cu_abb46837d774b5be81a6c601c762ab05a}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!CleanupGPU\_AutoCorr@{CleanupGPU\_AutoCorr}}
\index{CleanupGPU\_AutoCorr@{CleanupGPU\_AutoCorr}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
...
\end{DoxyCode}
\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_a6388d047bba2ea16de2bcb73ca0e398c}\label{gpuMCMCProcessorUtils_8cu_a6388d047bba2ea16de2bcb73ca0e398c}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!CopyToGPU\_AutoCorr@{CopyToGPU\_AutoCorr}}
\index{CopyToGPU\_AutoCorr@{CopyToGPU\_AutoCorr}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
...
\end{DoxyCode}
\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_a2e9d69f5be6976ac042f93045753acf9}\label{gpuMCMCProcessorUtils_8cu_a2e9d69f5be6976ac042f93045753acf9}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!EvalOnGPU\_AutoCorr@{EvalOnGPU\_AutoCorr}}
\index{EvalOnGPU\_AutoCorr@{EvalOnGPU\_AutoCorr}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
...
\end{DoxyCode}
\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_a5f83eaf9a69d10b00a4078608bdd0674}\label{gpuMCMCProcessorUtils_8cu_a5f83eaf9a69d10b00a4078608bdd0674}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!InitGPU\_AutoCorr@{InitGPU\_AutoCorr}}
\index{InitGPU\_AutoCorr@{InitGPU\_AutoCorr}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
...
\end{DoxyCode}
\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_a809672193d24a096e6d4865109357070}\label{gpuMCMCProcessorUtils_8cu_a809672193d24a096e6d4865109357070}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!RunGPU\_AutoCorr@{RunGPU\_AutoCorr}}
\index{RunGPU\_AutoCorr@{RunGPU\_AutoCorr}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
...
\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_ad9b41c473ce2b52f562c1809d6b233ca}\label{gpuMCMCProcessorUtils_8cu_ad9b41c473ce2b52f562c1809d6b233ca}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!d\_nDraws@{d\_nDraws}}
\index{d\_nDraws@{d\_nDraws}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
\doxysubsubsection{\texorpdfstring{d\_nDraws}{d\_nDraws}}
{\footnotesize\ttfamily \+\_\+\+\_\+device\+\_\+\+\_\+ \+\_\+\+\_\+constant\+\_\+\+\_\+ int d\+\_\+n\+Draws}



Definition at line \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source_l00009}{9}} of file \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source}{gpu\+MCMCProcessor\+Utils.\+cu}}.

\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_a2612fc014389124064ca4e2c9c2eb616}\label{gpuMCMCProcessorUtils_8cu_a2612fc014389124064ca4e2c9c2eb616}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!d\_nEntries@{d\_nEntries}}
\index{d\_nEntries@{d\_nEntries}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
\doxysubsubsection{\texorpdfstring{d\_nEntries}{d\_nEntries}}
{\footnotesize\ttfamily \+\_\+\+\_\+device\+\_\+\+\_\+ \+\_\+\+\_\+constant\+\_\+\+\_\+ int d\+\_\+n\+Entries}



Definition at line \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source_l00010}{10}} of file \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source}{gpu\+MCMCProcessor\+Utils.\+cu}}.

\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_af8f4968d58719d599f3d6ac1adecf9bd}\label{gpuMCMCProcessorUtils_8cu_af8f4968d58719d599f3d6ac1adecf9bd}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!d\_nLag@{d\_nLag}}
\index{d\_nLag@{d\_nLag}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
\doxysubsubsection{\texorpdfstring{d\_nLag}{d\_nLag}}
{\footnotesize\ttfamily \+\_\+\+\_\+device\+\_\+\+\_\+ \+\_\+\+\_\+constant\+\_\+\+\_\+ int d\+\_\+n\+Lag}



Definition at line \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source_l00008}{8}} of file \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source}{gpu\+MCMCProcessor\+Utils.\+cu}}.

\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_afe4d63f9540a121d02444724ba2abe10}\label{gpuMCMCProcessorUtils_8cu_afe4d63f9540a121d02444724ba2abe10}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!h\_nDraws@{h\_nDraws}}
\index{h\_nDraws@{h\_nDraws}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
\doxysubsubsection{\texorpdfstring{h\_nDraws}{h\_nDraws}}
{\footnotesize\ttfamily int h\+\_\+n\+Draws = -\/1\hspace{0.3cm}{\ttfamily [static]}}



Definition at line \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source_l00014}{14}} of file \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source}{gpu\+MCMCProcessor\+Utils.\+cu}}.

\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_adbc5ade24b4b04c29d1437f78a3f8923}\label{gpuMCMCProcessorUtils_8cu_adbc5ade24b4b04c29d1437f78a3f8923}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!h\_nEntries@{h\_nEntries}}
\index{h\_nEntries@{h\_nEntries}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
\doxysubsubsection{\texorpdfstring{h\_nEntries}{h\_nEntries}}
{\footnotesize\ttfamily int h\+\_\+n\+Entries = -\/1\hspace{0.3cm}{\ttfamily [static]}}



Definition at line \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source_l00015}{15}} of file \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source}{gpu\+MCMCProcessor\+Utils.\+cu}}.

\mbox{\Hypertarget{gpuMCMCProcessorUtils_8cu_a3d609e7d3946c09c05beebd1f703f355}\label{gpuMCMCProcessorUtils_8cu_a3d609e7d3946c09c05beebd1f703f355}} 
\index{gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}!h\_nLag@{h\_nLag}}
\index{h\_nLag@{h\_nLag}!gpuMCMCProcessorUtils.cu@{gpuMCMCProcessorUtils.cu}}
\doxysubsubsection{\texorpdfstring{h\_nLag}{h\_nLag}}
{\footnotesize\ttfamily int h\+\_\+n\+Lag = -\/1\hspace{0.3cm}{\ttfamily [static]}}



Definition at line \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source_l00013}{13}} of file \mbox{\hyperlink{gpuMCMCProcessorUtils_8cu_source}{gpu\+MCMCProcessor\+Utils.\+cu}}.
